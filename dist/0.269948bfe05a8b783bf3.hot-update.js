...
let UsersService = class UsersService {
    async kakaoCode(body) {
        ...
        const headers = { Authorization: `Bearer ${getToken.data.access_token}` };
        const getUserInfo = await axios_1.default.post(`https://kapi.kakao.com/v2/user/me`, '', headers);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("749183d95813a75b0e94")
/******/ })();
/******/ 
/******/ }
;